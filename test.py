...
from test2 import get_bid_test
from test3 import get_trump 
from gameplay import playing
...
def play(request: Request):
   ...
   # print(body)
    ...
    return json(playing(body))



if __name__ == "__main__":
    # Docker image should always listen in port 8001
    app.run(host="0.0.0.0", port=8001, debug=True, access_log=True, auto_reload=True)